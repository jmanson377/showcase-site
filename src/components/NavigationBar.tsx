...
const NavigationBar: Component = (props) => {
    const [hidden, setHidden] = createSignal(true);

    return (
        <nav class="py-4 md:py-0 px-4 text-lg text-gray-700 bg-cyan-50">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a>Logo of some sort</a>
                ...
                <div id="navbar" class={hidden() ? "hidden w-full md:block md:w-auto" : "w-full md:block md:w-auto"}>
